...
const routineVideos: Record<string, VideoStep[]> = {
  'Routine Mattutina': [
    { id: '1', title: 'Morning Cleansing', description: 'Routine Mattutina', duration: '1 min, 32 sec' },
    { id: '2', title: 'Toner', description: 'Routine Mattutina', duration: '38 sec' },
    { id: '3', title: 'Face Oil', description: 'Routine Mattutina', duration: '1 min, 12 sec' },
    { id: '4', title: 'Moisturizer', description: 'Routine Mattutina', duration: '45 sec' },
    { id: '5', title: 'Sunscreen', description: 'Routine Mattutina', duration: '1 min, 5 sec' },
  ],
  'Routine Serale': [
    { id: '1', title: 'Makeup Removal', description: 'Routine Serale', duration: '1 min, 20 sec' },
    { id: '2', title: 'Evening Cleanse', description: 'Routine Serale', duration: '1 min, 10 sec' },
    { id: '3', title: 'Exfoliation', description: 'Routine Serale', duration: '2 min' },
    { id: '4', title: 'Night Serum', description: 'Routine Serale', duration: '1 min' },
    { id: '5', title: 'Night Cream', description: 'Routine Serale', duration: '50 sec' },
  ],
  'Maschera Idratante': [
    { id: '1', title: 'Preparation', description: 'Maschera Idratante', duration: '45 sec' },
    { id: '2', title: 'Application', description: 'Maschera Idratante', duration: '1 min, 30 sec' },
    { id: '3', title: 'Wait Time', description: 'Maschera Idratante', duration: '15 min' },
    { id: '4', title: 'Removal', description: 'Maschera Idratante', duration: '1 min, 15 sec' },
  ],
  'Esfoliazione Delicata': [
    { id: '1', title: 'Skin Prep', description: 'Esfoliazione Delicata', duration: '40 sec' },
    { id: '2', title: 'Exfoliation', description: 'Esfoliazione Delicata', duration: '2 min' },
    { id: '3', title: 'Massage', description: 'Esfoliazione Delicata', duration: '1 min, 30 sec' },
    { id: '4', title: 'Rinse', description: 'Esfoliazione Delicata', duration: '1 min' },
  ],
  'Trattamento Viso Settimanale': [
    { id: '1', title: 'Preparation', description: 'Trattamento Viso Settimanale', duration: '1 min' },
    { id: '2', title: 'Deep Cleanse', description: 'Trattamento Viso Settimanale', duration: '2 min, 30 sec' },
    { id: '3', title: 'Mask', description: 'Trattamento Viso Settimanale', duration: '15 min' },
    { id: '4', title: 'Treatment Serum', description: 'Trattamento Viso Settimanale', duration: '1 min, 20 sec' },
    { id: '5', title: 'Final Step', description: 'Trattamento Viso Settimanale', duration: '1 min' },
  ],
  'Relax & Self-Care': [
    { id: '1', title: 'Face Massage', description: 'Relax & Self-Care', duration: '5 min' },
    { id: '2', title: 'Relaxing Mask', description: 'Relax & Self-Care', duration: '15 min' },
    { id: '3', title: 'Eye Area', description: 'Relax & Self-Care', duration: '2 min' },
    { id: '4', title: 'Meditation', description: 'Relax & Self-Care', duration: '10 min' },
  ],
};
