      ...
      <section className="mb-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {academyContent.map((item, index) => (
            <div key={index} className="lovi-card p-0 overflow-hidden cursor-pointer hover:scale-[1.02] transition-transform">
      ...
      <section className="mb-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {massageGuides.map((item, index) => (
            <div key={index} className="relative cursor-pointer hover:scale-[1.02] transition-transform">
